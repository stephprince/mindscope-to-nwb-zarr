...
def convert_visual_coding_ophys_hdf5_to_zarr(results_dir: Path, scratch_dir: Path) -> Path | None:
    ...
    with NWBHDF5IO(str(processed_file_path), 'r') as processed_io:
        ...
        # Add the complementary 2p-frame-aligned eye tracking product (AllenSDK get_eye_tracking,
        # generated by AllenInstitute/visual-coding-saccades). Present for 818/1518 experiments;
        # a no-op otherwise. Stored under *_dlc names, timestamped by the dF/F frame clock.
