...
instrument = Instrument(
    location="Unknown",
    instrument_id="CAM2P.1",
    modification_date=date(2015, 3, 31),
    coordinate_system=CoordinateSystemLibrary.BREGMA_ARI,
    modalities=[Modality.POPHYS, Modality.BEHAVIOR_VIDEOS],
    notes="Created several years posthoc from incomplete records. Much information is missing. Detector was proprietary part of Nikon.",
...
if __name__ == "__main__":
    ...
    deserialized.write_standard_file(prefix="cam2p1_original_")