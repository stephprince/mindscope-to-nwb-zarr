...
nwbfile = read_nwb("/Users/stephprince/Documents/code/mindscope-to-nwb-zarr/data/sub-703279277_ses-719161530_probe-729445654_ecephys.nwb")
...
acquisition = Acquisition(
    experimenters="MISSING",
    subject_id=nwbfile.subject.subject_id,
    acquisition_start_time=nwbfile.session_start_time,
    acquisition_end_time="MISSING", # TODO - calculate from electrical series last time point?
    acquisition_type=nwbfile.session_description, # TODO - anything better? allen sdk project code
    instrument_id="MISSING", # TODO - devices? or allensdk 
    ethics_review_id=["MISSING"],
)
